				...
				<div class="col-lg-8">
					<div class="row">
						...
						@foreach ($posts as $all_posts)
							@if ($all_posts->categories->name == 'Lamda')
								<div class="col-lg-6 col-sm-6">
									<div class="single_post post_1">
										<div class="single_post_img">
											...
											<img src={{ "public/storage/".$all_posts->post_image }} alt="">
										</div>
										<div class="single_post_text text-center">
											<a href="category.html">
												<h5> {{ $all_posts->categories->name }} </h5>
											</a>
											<a href="single-blog.html">
												<h2>{{ $all_posts->MainTitle }}</h2>
											</a>
											<p><i class="far fa-clock"></i> {{ $all_posts->created_at->diffforhumans() }}&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-user"></i> {{ Str::limit($all_posts->user->name,10) }}</p>
							...
							@if ($all_posts->categories->name == 'Database')
								<div class="col-lg-6 col-sm-6">
									<div class="single_post post_1">
										<div class="single_post_img">
											<span class="badge badge-pill badge-info"><i class="fas fa-star" style="color: orange;"></i> Recent Post</span>
											<img src="{!! asset('public/storage/'.$all_posts->post_image) !!}" alt="">
										</div>
										<div class="single_post_text text-center">
											<a href="category.html">
												<h5> {{ $all_posts->categories->name }}</h5>
