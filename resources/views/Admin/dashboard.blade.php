<x-admin_index>
   @section('dashboard_content')
      ...
      <div class="row">
         <div class="col-xl-3 col-md-6 mb-3" style="height: 130px;">
            <div class="card border-left-primary shadow h-100 py-1">
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Blog Post</div>
                        <div class="h5  font-weight-bold text-gray-800 mb-2 mt-2 p-1"> 40 </div>
                        <div class="">
         ...
         <div class="col-xl-3 col-md-6 mb-3" style="height: 130px;">
            <div class="card border-left-success shadow h-100 py-1">
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Users Registered</div>
               ...
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        ...
                        <div class="h5  font-weight-bold text-gray-800 mb-2 mt-2 p-1"> 12 </div>
                        <div class="">
                           <a href="{!! route('view_users') !!}"> View Here </a>
                        </div>
                     </div>
               ...
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        ...
                        <div class="h5  font-weight-bold text-gray-800 mb-2 mt-2 p-1"> 5 </div>
                        <div class="">
                           <a href="{!! route('view_users') !!}"> View Here </a>
                        </div>
                     </div>
